...
public class AuditingEventListener implements ApplicationListener<BeforeConvertEvent<Object>> {
	...
	private volatile IsNewAwareAuditingHandler auditHandler;
	...
	public void onApplicationEvent(BeforeConvertEvent<Object> event) {
		...
		getAuditHandler().markAudited(entity);
	}

	/**
	 * @return
	 */
	private IsNewAwareAuditingHandler getAuditHandler() {
		return auditHandler == null ? (auditHandler = auditingHandlerFactory.getObject()) : auditHandler;
	}
}
